...
Funcionalidade: Cadastro de filmes
    Para que eu possa disponibilizar novos titulos no catálogo
    Sendo um gestor de catálogo
    Posso cadastrar um novo filmes

    @new_movie
    Esquema do Cenario: Filme disponível
    ...
    Cenario: Duplicado
        ...
        Quando eu faço o cadastro deste filme
        Então devo visualizar a notificação "Oops - Este titulo já existe no Ninjaflix."
